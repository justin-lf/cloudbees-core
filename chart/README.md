...
![Version: 3.40.2](https://img.shields.io/badge/Version-3.40.2-informational?style=flat-square) ![AppVersion: 2.319.3.4](https://img.shields.io/badge/AppVersion-2.319.3.4-informational?style=flat-square)
...
|------------|------|---------|
| https://charts.cloudbees.com/public/cloudbees | cloudbees-sidecar-injector | 2.2.2 |
...
| Agents.Image.dockerImage | string | `"cloudbees/cloudbees-core-agent:2.319.3.4"` | Used to override the default docker image used for agents |
...
| Master.Image.dockerImage | string | `"cloudbees/cloudbees-core-mm:2.319.3.4"` | Used to override the default docker image |
...
| OperationsCenter.Image.dockerImage | string | `"cloudbees/cloudbees-cloud-core-oc:2.319.3.4"` | Container image to use for Operations Center |
